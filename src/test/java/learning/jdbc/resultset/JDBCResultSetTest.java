...
public class JDBCResultSetTest {
    ...
    public void testReadBlob() throws SQLException, IOException, NoSuchAlgorithmException {
        ...
        PreparedStatement statement = conn.prepareStatement("INSERT INTO Books(Title,Price,Publisher_Id,Cover) VALUES ('Study in Scarlet',20,'0201',?)");
    ...
    @Test
    public void testAutoGeneratedKey() throws SQLException {
        PreparedStatement statement = conn.prepareStatement("INSERT INTO Books(Title,Price,Publisher_Id,Cover) VALUES ('Study in Scarlet',20,'0201',?)",Statement.RETURN_GENERATED_KEYS);
